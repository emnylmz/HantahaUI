...
// project imports
import SubCard from 'components/admin/cards/SubCard';
import MainCard from 'components/admin/cards/MainCard';
import SecondaryAction from 'components/admin/cards/CardSecondaryAction';
      ...
      <Grid item xs={12}>
        <SubCard title="Primary Color">
          <Grid container spacing={gridSpacing}>
            ...
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="primary.main" data={{ label: 'Blue-500', color: '#D4A373' }} title="primary.main" />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
